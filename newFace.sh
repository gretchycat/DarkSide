...
convert ~/Downloads/$1-icon.png -dither FloydSteinberg -monochrome resources/images/$1/darkside-icon.png
convert ~/Downloads/${1}.png -dither FloydSteinberg -monochrome resources/images/$1/darkside.png
pebble clean
pebble build
